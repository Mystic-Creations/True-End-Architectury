...
public class VersionOverlay {
    ...
    public static void onRenderGui(RenderGuiEvent.Post event) {
        ...
        gui.drawString(mc.font, Component.literal(net.mysticcreations.true_end.client.VersionOverlay.currentText), drawX + 1, drawY + 1, textShadowColor, false);
        gui.drawString(mc.font, Component.literal(net.mysticcreations.true_end.client.VersionOverlay.currentText), drawX, drawY, textColor, false);
